...
import '../../../../../contracts/YumyumSwapPool.sol';
import '../../../../../contracts/YumyumSwapFactory.sol';
...
contract SetupUniswap {
    ...
    YumyumSwapFactory factory;

    constructor(TestERC20 _token0, TestERC20 _token1) public {
        factory = new YumyumSwapFactory();
        token0 = _token0;
        token1 = _token1;
    }

    function createPool(uint24 _fee, uint160 _startPrice) public {
        pool = YumyumSwapPool(factory.createPool(address(token0), address(token1), _fee));
...
contract UniswapMinter {
    ...
    function setPool(YumyumSwapPool _pool) public {
        pool = _pool;
    }
