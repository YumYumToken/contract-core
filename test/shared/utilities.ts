...
export function createPoolFunctions({
  ...
  swapTarget: TestYumyumSwapCallee
  token0: TestERC20
  token1: TestERC20
  pool: MockTimeYumyumSwapPool
}): PoolFunctions {
...
export function createMultiPoolFunctions({
  ...
  swapTarget: TestYumyumSwapRouter
  poolInput: MockTimeYumyumSwapPool
  poolOutput: MockTimeYumyumSwapPool
}): MultiPoolFunctions {
