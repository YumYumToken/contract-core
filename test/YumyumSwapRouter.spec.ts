...
describe('YumyumSwapPool', () => {
  ...
  let pool0: MockTimeYumyumSwapPool
  let pool1: MockTimeYumyumSwapPool
  ...
  let swapTargetCallee: TestYumyumSwapCallee
  let swapTargetRouter: TestYumyumSwapRouter
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeYumyumSwapPool, any]> => {
